        ...
        <div className="space-y-8 p-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input type="number" placeholder="Usuários ativos · último dia" value={formData.ga4.activeUsers1d ?? ''} onChange={(e) => handleInputChange('ga4.activeUsers1d', parseInt(e.target.value || '0', 10))} className="rounded-lg border border-gray-300 px-4 py-2 focus:border-[#ff6737] focus:outline-none" />
              <input type="number" placeholder="Usuários ativos · 7 dias" value={formData.ga4.activeUsers7d ?? ''} onChange={(e) => handleInputChange('ga4.activeUsers7d', parseInt(e.target.value || '0', 10))} className="rounded-lg border border-gray-300 px-4 py-2 focus:border-[#ff6737] focus:outline-none" />
              <input type="number" placeholder="Usuários ativos · 30 dias" value={formData.ga4.activeUsers30d ?? ''} onChange={(e) => handleInputChange('ga4.activeUsers30d', parseInt(e.target.value || '0', 10))} className="rounded-lg border border-gray-300 px-4 py-2 focus:border-[#ff6737] focus:outline-none" />
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input type="number" placeholder="Domain Authority" value={formData.ubersuggest.domainAuthority} onChange={(e) => handleInputChange('ubersuggest.domainAuthority', parseInt(e.target.value || '0', 10))} className="rounded-lg border border-gray-300 px-4 py-2 focus:border-[#ff6737] focus:outline-none" />
              ...
              <input type="number" placeholder="Share of voice em IA (%)" step="0.01" value={formData.ubersuggest.aiVisibility.shareOfVoice} onChange={(e) => handleInputChange('ubersuggest.aiVisibility.shareOfVoice', parseFloat(e.target.value || '0'))} className="rounded-lg border border-gray-300 px-4 py-2 focus:border-[#ff6737] focus:outline-none" />
