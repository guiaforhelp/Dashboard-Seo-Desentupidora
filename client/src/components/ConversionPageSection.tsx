        ...
        <div className="card-premium bg-gradient-to-r from-green-50 to-white border border-green-200">
          <div className="space-y-6">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-[#203c50]">Desentupidora Blumenau Serviços para Santa Catarina</h3>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <div className="text-center p-3 bg-blue-100 rounded-lg">
                ...
                <p className="text-2xl font-bold text-[#203c50]">1,00</p>
              </div>
              <div className="text-center p-3 bg-blue-100 rounded-lg">
                <p className="text-xs text-gray-600 mb-1">Tempo Médio</p>
                <p className="text-2xl font-bold text-[#203c50]">17s</p>
              </div>
              <div className="text-center p-3 bg-blue-100 rounded-lg">
                <p className="text-xs text-gray-600 mb-1">Eventos</p>
                <p className="text-2xl font-bold text-[#203c50]">7</p>
              </div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800 leading-relaxed">
                  Essa página gerou conversão mesmo com apenas 17 segundos de engajamento médio. Isso indica uma <strong>intenção direta do usuário</strong>, 
                  ...
                  para aumentar a taxa de contato.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-200 flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-800 leading-relaxed">
                  Analise esta página com atenção. Ela converteu rapidamente, o que mostra potencial. Considere replicar seus elementos de sucesso 
                  em outras páginas locais para Perdizes, Morumbi, Pirituba, Ipiranga e Osasco.
                </p>
              </div>
            </div>
          </div>
