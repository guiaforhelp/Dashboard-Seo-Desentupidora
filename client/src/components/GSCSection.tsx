    ...
    <section className="border-b border-gray-200 py-12">
      <div className="container">
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4"><p className="text-xs font-semibold text-gray-600">Variação de CTR</p><p className="mt-2 text-base font-bold text-[#203c50]">Não disponível</p><p className="mt-1 text-xs text-gray-500">na captura atual</p></div>
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4"><p className="text-xs font-semibold text-gray-600">Variação de posição</p><p className="mt-2 text-base font-bold text-[#203c50]">Não disponível</p><p className="mt-1 text-xs text-gray-500">na captura atual</p></div>
        </div>
