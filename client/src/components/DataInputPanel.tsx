        ...
        <div className="space-y-8 p-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input type="number" placeholder="Palavras-chave pagas" value={formData.ubersuggest.paidKeywords} onChange={(e) => handleInputChange('ubersuggest.paidKeywords', parseInt(e.target.value || '0', 10))} className="rounded-lg border border-gray-300 px-4 py-2 focus:border-[#ff6737] focus:outline-none" />
