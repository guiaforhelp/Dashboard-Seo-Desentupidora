    ...
    <section className="border-b border-gray-200 py-12">
      <div className="container">
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-xl border border-green-200 bg-green-50 p-4"><p className="text-xs font-semibold text-gray-600">Variação de CTR</p><p className="mt-2 text-2xl font-bold text-green-700">+{data.ctrChangePp.toLocaleString('pt-BR', { minimumFractionDigits: 1 })} p.p.</p><p className="mt-1 text-xs text-gray-500">de {data.ctrPrevious.toLocaleString('pt-BR', { minimumFractionDigits: 1 })}% para {data.ctr.toLocaleString('pt-BR', { minimumFractionDigits: 1 })}%</p></div>
